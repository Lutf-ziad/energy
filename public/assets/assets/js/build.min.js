...
(function($) {
    ...
    $(".mob-menu-toggler").on("click", function() {
        ...
        $('.mob-nav-bg').addClass('show');
        return false;
    });
    $('.mob-nav-bg, .mob-menu-close-btn').on("click", function() {
        $('.header-nav').removeClass('show');
        $('.mob-nav-bg').removeClass('show');
        return false;
    });

    $('.header-nav .has-submenu > a').on("click", function() {
        return false;
    });
    ...
    function onScrollHandle() {
        ...
        $(".site-header").toggleClass("has-scrolled", $(this).scrollTop() > 50);
