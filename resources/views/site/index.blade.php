    ...
    <div class="am-tabs-set-wrap home-tabs-set" dir="rtl">
        ...
        <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade" id="tabchangan">
                <div class="row">
                    <div class="col-md-6 order-md-1 tab-img-col">
                        <img src="{{ asset('uploads/hhh-01.png') }}" alt="">
                    </div>
                    <div class="col-md-6 text-right">
                        <div class="p-4">
                            <h4>فروعنا</h4>
                        <p>"نحن نفخر بتقديم خدماتنا عبر أكثر من 140 فرع متواجد في جميع أنحاء المملكة العربية السعودية. توزع هذه الفروع استراتيجيًا لضمان توفر وصول سهل وسريع إلى منتجاتنا وخدماتنا في جميع المدن والمناطق. هذا الانتشار الواسع يعكس التزامنا الراسخ بتلبية احتياجات عملائنا وضمان رضاهم.
            ...
            <div class="tab-pane fade" id="tabuni">
                <div class="row">
                    <div class="col-md-6 order-md-1 tab-img-col">
                        <img src="{{ asset('uploads/4c.jpg') }}" alt="">
                    </div>
                    <div class="col-md-6 text-right">
                        <div class="p-4">
                            <h4>منتجاتنا</h4>
