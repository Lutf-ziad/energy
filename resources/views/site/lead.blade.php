        ...
        <div class="container">
            <div class="row">
                ...
                <div class="history-years">
                                ...
                                <div class="history-content">
                                    <div class="title-top">
                                        ...
                                        <div class="content-set">
                                            ...
                                            <div class="history-text">
                                                <p>أرامكو السعودية تتعاون</p>
                                            </div>
                                            <div class="red-rectangle">
                                                <img decoding="async" src="{{ asset('uploads/n.jpg') }}" alt="1968 image">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="history-content">
                                    <div class="title-top row-reverse">
                                        ...
                                        <div class "content-set">
                                            ...
                                            <div class="red-rectangle">
                                                <img decoding="async" src="{{ asset('uploads/n2.jpg') }}" alt="1969 image">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="history-content">
                                    <div class="title-top">
                                        ...
                                        <div class="content-set">
                                            ...
                                            <div class="history-text">
                                                <p>إفتتاح أول شركة إكسبرس في مصر</p>
                                            </div>
                                            <div class="red-rectangle">
                                                <img decoding="async" src="{{ asset('uploads/n3.jpg') }}" alt="2015 image">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row mobile-content-center">
                        <div class="history row-reverse">
                            <div class="history-title year12 reverse">
                                <div class="dot-line"></div>
                            </div>
                        </div>
                    </div>
