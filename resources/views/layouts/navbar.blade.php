    ...
    <div class="am-tabs-set-wrap home-tabs-set" dir="rtl">
        <div class="container-fluid mw-1200">
            <ul class="nav nav-pills nav-justified" id="myTab" role="tablist">
                ...
                <li class="nav-item" role="presentation"><a class="nav-link" data-toggle="tab" href="#tabuni">النشرة الإخبارية</a></li>
                <li class="nav-item" role="presentation"><a class="nav-link" data-toggle="tab" href="#tabuni2">ملف الشركة</a></li>
            </ul>
                ...
                <div class="tab-pane fade" id="tabchangan">
                    <div class="row">
                        ...
                        <div class="col-md-6 text-right">
                            <div class="p-4">
                                <h4>فروعنا</h4>
                                <p>تفخر شركتنا بتواجد أكثر من 150 فرعًا منتشرة في جميع أنحاء المملكة العربية السعودية. نحن نقدم خدماتنا ومنتجاتنا الاستثنائية في مناطق رئيسية، والتي تعتبر سبب نجاحنا المتواصل.
                                    مجالنا، والتي تعتبر سبب رئيسي وراء انتشارنا الواسع ونجاحنا المتواصل.
                                </p>
                ...
                <div class="tab-pane fade" id="tabuni2">
                    <div class="row">
                        ...
                        <div class ="col-md-6 text-right">
                            <div class="p-4">
                                <h4>ملف الشركة</h4>
                                <p>شركة مشاريع الطاقة تقدم مجموعة واسعة من المنتجات عالية الجودة في مجال الطاقة. تتخصص الشركة في توفير بطاريات ذات جودة عالية وأداء ممتاز. بطاريات شركة مشاريع الطاقة تتميز بالموثوقية والكفاءة، مما يسمح للعملاء بتخزين واستخدام الطاقة بشكل فعال.</p>
    ...
    <div class="container-fluid mw-1200">
        ...
        <div class="d-flex align-items-center">
            <a href="{{ url('lead') }}" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Award', '', '{{asset('uploads/111-01-01-01.png')}}', 1)">
                <img id="Award" src="{{asset('uploads/2114-01.png')}}" alt="">
            </a>
        </div>
        <hr>
    </div>
    ...
    <div class="container-fluid mw-1200">
        ...
        <div class="row">
            <div class="col-sm-6 col-lg-3">
                <div class="offer-box">
                    <div class="embed-responsive embed-responsive-1by1">
                        <a href="offer-detail.php.html?id=136">
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="offer-box">
                    <div class="embed-responsive embed-responsive-1by1">
                        <a href="offer-detail.php-1.html?id=131">
                            <img src="{{asset('uploads/new7.jpeg')}}" alt="" class="embed-responsive-item">
                        </a>
                    </div>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="offer-box">
                    <div class="embed-responsive embed-responsive-1by1">
                        <a href="offer-detail.php-2.html?id=130">
                            <img src="{{asset('uploads/new6.jpeg')}}" alt="" class="embed-responsive-item">
                        </a>
                    </div>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="offer-box">
                    <div class="embed-responsive embed-responsive-1by1">
                        <a href="offer-detail.php-3.html?id=129">
                            <img src="{{asset('uploads/new10.jpeg')}}" alt="" class="embed-responsive-item">
                        </a>
                    </div>
